...
const AddressSchema: Schema<AddressInterface> = new Schema<AddressInterface>(
  {
    city: {
      type: String,
      trim: true,
    ...
    woreda: {
      ...
      minlength: [3, 'A woreda name must have more or equal then 3 characters'],
    },
    street: {
      type: String,
      trim: true,
      required: [true, 'An address must have a street'],
      minlength: [3, 'A street name must have more or equal then 3 characters'],
    },
  },
  { _id: false }
);
